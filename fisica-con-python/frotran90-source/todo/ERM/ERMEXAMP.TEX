%%% ====================================================================
%%%
%%% Este es el archivo testmath.tex de la distribución AmSLaTeX, que
%%% se incluye el la distribución ErMLaTeX para ejemplificar el uso
%%% de los macros de la revista de la Escuela Regional de Matemáticas.
%%%
%%%                                Jairo Duque, 06.02.02
%%%
%%% ====================================================================
%%%  @LaTeX-file{
...
%%%  }
%%% ====================================================================
\documentclass[twoside]{erm}

\title{Sample Paper for the \pkg{amsmath} Package\\
File name: \fn{testmath.tex}}
\author{American Mathematical Society \\ {\small http:/\!/www.ams.org} 
         \address{American Mathematical Society, P.O. Box 6248, Providence, RI 02940-6248} \mail{tech-support@ams.org} 
       \and 
       Article in format ERM \\ {\small http:/\!/erm.udenar.edu.co}
         \address{Escuela Regional de Matemáticas, Universidad del Valle, Depto. de Matemáticas, A.A. 25360} 
         \mail{revistaerm@univalle.edu.co}}
%%%
%%% Al final aparecerá toda la información declarada en \author{...},
%%% a menos que use los comandos \noauthorinfo y \authorinfo.
%%% Consulte el manual para más información.
%%%
\markauthor{Sample paper for the {\protect\ntt\lowercase{erm}} style y {\protect\ntt\lowercase{amsmath}} package }
...
%%% =========================================================================
%%%
%%% No use el comando \markboth! 
%%% El estilo ERM redefine estos encabezados.
%%%
%%% Originalmente:
...
\begin{verbatim}
\begin{align}
\begin{split}\abs{I_1}&=\left\lvert \int_\Omega gRu\,d
     \Omega\right\rvert\\
  &\le C_3\left[\int_\Omega\left(\int_{a}^x
  g(x\i,t)\,d\xi\right)^2d\Omega\right]^{1/2}\\
&\quad\times \left[\int_\Omega\left\{u^2_x+\frac{1}{k}
...
&\le C_4\left\lvert \left\lvert f\left\lvert \wt{S}^{-1,0}_{a,-}
  ...
  (\Omega;\Gamma_r,T)\right\rvert\right\rvert.
\end{split}\label{eq:A}\\
\begin{split}\abs{I_2}&=\left\lvert \int_{0}^T \psi(t)
