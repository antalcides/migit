...
\title{\color{black}{\Large REPASO DE ESTADÍSTICA II}}
\author{\color{black}\bfseries Antalcides Olivo \\ \vspace{4cm} \sffamily {\small \noindent Copyright ©{} 2003 Antalcides Olivo
Burgos. Universidad Del Norte}
}

\orgname{\color{black}UNIVERSIDAD DEL NORTE} \orgurl{%
\color{black}http://www.uninorte .edu .co}
\address{\color{black}\large Julio del 2003} \clearpage
 \maketitle
 
\overlay{figuras/estadis1.png}


{\large\textbf{\include{repaso6} \include{repaso7}}}
