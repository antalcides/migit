...
%TCIDATA{LastRevised=Monday, September 29, 2003 10:31:19}
...
'HLZF4700.wmf';tempfile-properties "XPR";}}
...
"-5,5";num-x-gridlines 49;curveColor "[flat::RGB:0000000000]";curveStyle
"Line";rangeset"X";valid_file "T";tempfilename
'HLZF4701.wmf';tempfile-properties "XPR";}}%
%\end{enumerate}
...
"T";tempfilename 'HLZF4702.wmf';tempfile-properties "XPR";}}\centering%
\includegraphics[
...
"-5,5";num-x-gridlines 49;curveColor "[flat::RGB:0000000000]";curveStyle
"Line";rangeset"X";valid_file "T";tempfilename
'HLZF4703.wmf';tempfile-properties "XPR";}}%
\end{tabular}
...
"Solid";var1range "-5,5";num-x-gridlines 49;curveColor
"[flat::RGB:0000000000]";curveStyle "Line";rangeset"X";valid_file
"T";tempfilename 'HLZF4704.wmf';tempfile-properties "XPR";}}
...
'HLZF4705.wmf';tempfile-properties "XPR";}}
...
"point";linethickness 3;lineAttributes "Solid";var1range
"-5,5";num-x-gridlines 49;curveColor "[flat::RGB:0000000000]";curveStyle
"Line";valid_file "T";tempfilename 'HLZF4706.wmf';tempfile-properties "XPR";}%
}
\end{enumerate}
...
cropbottom "0"; filename '../Documents and
Settings/aolivo/Escritorio/present/ajuste.jpg';file-properties "XNPEU";}}
...
croptop "1"; cropright "1"; cropbottom "0"; filename '../Documents and
Settings/aolivo/Escritorio/present/ajuste1.jpg';file-properties "XNPEU";}}y
se dice que el modelo es bueno si $r^{2}>0.95$
...
cropbottom "0"; filename '../Documents and
Settings/aolivo/Escritorio/present/ajuste2.jpg';file-properties "XNPEU";}}y
decimos que el modelo es bueno si el mean Square Error es despreciable
comparado con $\bar{y}$ %\end{enumerate}
