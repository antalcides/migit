...
\def\place{Dpt de Física} % `place' or 'conference, place'
...
\newsavebox{\myLoewe}
\sbox{\myLoewe}{\includegraphics[scale=0.14]{logofoto.eps}}
...
%\begin{dinglist}{253}
%\overlay{1}{%
%\Blue{\item\Black{ {\Blue{\huge\bf ¿Qu\'{e} es la estadística?} }
\begin{slide}
\include{agrafico}
\end{slide}
%\begin{slide}
...
%%\begin{dinglist}{253}
%%\overlay{2}{%
%\Blue{\item\Black{ {\Blue{\huge\bf ¿Qué es la estadística?}}%
%\include{repaso2}
%%}}% end color
%%}% end overlay
%%\end{dinglist}
