...
Markdown}, and (subsets of) \href{http://redcloth.org/textile}{Textile},
...
\protect\hyperlink{extension-markdownux5finux5fhtmlux5fblocks}{Markdown
inside HTML block elements}. (These enhancements, described below under
...
\texttt{commonmark} (CommonMark Markdown), \texttt{textile} (Textile),
\texttt{rst} (reStructuredText), \texttt{html} (HTML), \texttt{docbook}
(DocBook), \texttt{t2t} (txt2tags), \texttt{docx} (docx), \texttt{odt}
(ODT), \texttt{epub} (EPUB), \texttt{opml} (OPML), \texttt{org} (Emacs
Org mode), \texttt{mediawiki} (MediaWiki markup), \texttt{twiki} (TWiki
markup), \texttt{haddock} (Haddock markup), or \texttt{latex} (LaTeX).
If \texttt{+lhs} is appended to \texttt{markdown}, \texttt{rst},
...
(reStructuredText), \texttt{html} (XHTML), \texttt{html5} (HTML5),
...
\texttt{textile} (Textile), \texttt{org} (Emacs Org mode),
\texttt{texinfo} (GNU Texinfo), \texttt{opml} (OPML), \texttt{docbook}
(DocBook), \texttt{opendocument} (OpenDocument), \texttt{odt}
...
Word ``Track Changes'' feature. \texttt{accept} (the default), inserts
all insertions, and ignores all deletions. \texttt{reject} inserts all
deletions and ignores insertions. \texttt{all} puts in both insertions
and deletions, wrapped in spans with \texttt{insertion} and
\texttt{deletion} classes, respectively. The author and time of change
is included. \texttt{all} is useful for scripting: only accepting
...
effect on \texttt{man}, \texttt{docbook}, \texttt{slidy},
\texttt{slideous}, \texttt{s5}, or \texttt{odt} output.
...
or hexadecimal character references. The default is \texttt{javascript}.
...
\texttt{docbook} as well as \texttt{html} and \texttt{html5}). In
standalone \texttt{html} output, a small javascript (or a link to such a
script if a \emph{URL} is supplied) will be inserted that allows the
...
\protect\hyperlink{extension-yamlux5fmetadataux5fblock}{YAML metadata
blocks}. They may also be set at the command line using the
...
\protect\hyperlink{extension-pandocux5ftitleux5fblock}{pandoc title
block}, which allows for multiple authors, or through a YAML metadata
block:
...
\texttt{escaped\_line\_breaks}}{Extension: escaped\_line\_breaks}}\label{extension-escapedux5flineux5fbreaks}
...
\paragraph{\texorpdfstring{Extension:
\texttt{blank\_before\_header}}{Extension: blank\_before\_header}}\label{extension-blankux5fbeforeux5fheader}
...
\paragraph{\texorpdfstring{Extension:
\texttt{header\_attributes}}{Extension: header\_attributes}}\label{extension-headerux5fattributes}
...
\paragraph{\texorpdfstring{Extension:
\texttt{auto\_identifiers}}{Extension: auto\_identifiers}}\label{extension-autoux5fidentifiers}
...
\paragraph{\texorpdfstring{Extension:
\texttt{implicit\_header\_references}}{Extension: implicit\_header\_references}}\label{extension-implicitux5fheaderux5freferences}
...
\paragraph{\texorpdfstring{Extension:
\texttt{blank\_before\_blockquote}}{Extension: blank\_before\_blockquote}}\label{extension-blankux5fbeforeux5fblockquote}
...
\paragraph{\texorpdfstring{Extension:
\texttt{fenced\_code\_blocks}}{Extension: fenced\_code\_blocks}}\label{extension-fencedux5fcodeux5fblocks}
...
\paragraph{\texorpdfstring{Extension:
\texttt{backtick\_code\_blocks}}{Extension: backtick\_code\_blocks}}\label{extension-backtickux5fcodeux5fblocks}

Same as \texttt{fenced\_code\_blocks}, but uses backticks (\texttt{`})
instead of tildes (\texttt{\textasciitilde{}}).

\paragraph{\texorpdfstring{Extension:
\texttt{fenced\_code\_attributes}}{Extension: fenced\_code\_attributes}}\label{extension-fencedux5fcodeux5fattributes}
...
\paragraph{\texorpdfstring{Extension:
\texttt{line\_blocks}}{Extension: line\_blocks}}\label{extension-lineux5fblocks}
...
\paragraph{\texorpdfstring{Extension:
\texttt{fancy\_lists}}{Extension: fancy\_lists}}\label{extension-fancyux5flists}
...
\paragraph{\texorpdfstring{Extension:
\texttt{definition\_lists}}{Extension: definition\_lists}}\label{extension-definitionux5flists}
...
\paragraph{\texorpdfstring{Extension:
\texttt{example\_lists}}{Extension: example\_lists}}\label{extension-exampleux5flists}
...
\paragraph{\texorpdfstring{Extension:
\texttt{table\_captions}}{Extension: table\_captions}}\label{extension-tableux5fcaptions}
...
\paragraph{\texorpdfstring{Extension:
\texttt{simple\_tables}}{Extension: simple\_tables}}\label{extension-simpleux5ftables}
...
\paragraph{\texorpdfstring{Extension:
\texttt{multiline\_tables}}{Extension: multiline\_tables}}\label{extension-multilineux5ftables}
...
\paragraph{\texorpdfstring{Extension:
\texttt{grid\_tables}}{Extension: grid\_tables}}\label{extension-gridux5ftables}
...
\paragraph{\texorpdfstring{Extension:
\texttt{pipe\_tables}}{Extension: pipe\_tables}}\label{extension-pipeux5ftables}
...
\hypertarget{extension-pandocux5ftitleux5fblock}{\paragraph{\texorpdfstring{Extension:
\texttt{pandoc\_title\_block}}{Extension: pandoc\_title\_block}}\label{extension-pandocux5ftitleux5fblock}}
...
\hypertarget{extension-yamlux5fmetadataux5fblock}{\paragraph{\texorpdfstring{Extension:
\texttt{yaml\_metadata\_block}}{Extension: yaml\_metadata\_block}}\label{extension-yamlux5fmetadataux5fblock}}
...
\paragraph{\texorpdfstring{Extension:
\texttt{all\_symbols\_escapable}}{Extension: all\_symbols\_escapable}}\label{extension-allux5fsymbolsux5fescapable}
...
\paragraph{\texorpdfstring{Extension:
\texttt{intraword\_underscores}}{Extension: intraword\_underscores}}\label{extension-intrawordux5funderscores}
...
\paragraph{\texorpdfstring{Extension:
\texttt{inline\_code\_attributes}}{Extension: inline\_code\_attributes}}\label{extension-inlineux5fcodeux5fattributes}
...
\paragraph{\texorpdfstring{Extension:
\texttt{tex\_math\_dollars}}{Extension: tex\_math\_dollars}}\label{extension-texux5fmathux5fdollars}
...
\paragraph{\texorpdfstring{Extension:
\texttt{raw\_html}}{Extension: raw\_html}}\label{extension-rawux5fhtml}
...
\hypertarget{extension-markdownux5finux5fhtmlux5fblocks}{\paragraph{\texorpdfstring{Extension:
\texttt{markdown\_in\_html\_blocks}}{Extension: markdown\_in\_html\_blocks}}\label{extension-markdownux5finux5fhtmlux5fblocks}}
...
\paragraph{\texorpdfstring{Extension:
\texttt{native\_divs}}{Extension: native\_divs}}\label{extension-nativeux5fdivs}
...
\paragraph{\texorpdfstring{Extension:
\texttt{native\_spans}}{Extension: native\_spans}}\label{extension-nativeux5fspans}
...
\paragraph{\texorpdfstring{Extension:
\texttt{raw\_tex}}{Extension: raw\_tex}}\label{extension-rawux5ftex}
...
\paragraph{\texorpdfstring{Extension:
\texttt{latex\_macros}}{Extension: latex\_macros}}\label{extension-latexux5fmacros}
...
\paragraph{\texorpdfstring{Extension:
\texttt{shortcut\_reference\_links}}{Extension: shortcut\_reference\_links}}\label{extension-shortcutux5freferenceux5flinks}
...
\paragraph{\texorpdfstring{Extension:
\texttt{implicit\_figures}}{Extension: implicit\_figures}}\label{extension-implicitux5ffigures}
...
\hypertarget{extension-linkux5fattributes}{\paragraph{\texorpdfstring{Extension:
\texttt{link\_attributes}}{Extension: link\_attributes}}\label{extension-linkux5fattributes}}
...
\paragraph{\texorpdfstring{Extension:
\texttt{inline\_notes}}{Extension: inline\_notes}}\label{extension-inlineux5fnotes}
...
\paragraph{\texorpdfstring{Extension:
\texttt{lists\_without\_preceding\_blankline}}{Extension: lists\_without\_preceding\_blankline}}\label{extension-listsux5fwithoutux5fprecedingux5fblankline}

Allow a list to occur right after a paragraph, with no intervening blank
space.

\paragraph{\texorpdfstring{Extension:
\texttt{hard\_line\_breaks}}{Extension: hard\_line\_breaks}}\label{extension-hardux5flineux5fbreaks}

Causes all newlines within a paragraph to be interpreted as hard line
breaks instead of spaces.

\paragraph{\texorpdfstring{Extension:
\texttt{ignore\_line\_breaks}}{Extension: ignore\_line\_breaks}}\label{extension-ignoreux5flineux5fbreaks}
...
\paragraph{\texorpdfstring{Extension:
\texttt{east\_asian\_line\_breaks}}{Extension: east\_asian\_line\_breaks}}\label{extension-eastux5fasianux5flineux5fbreaks}
...
\paragraph{\texorpdfstring{Extension:
\texttt{tex\_math\_single\_backslash}}{Extension: tex\_math\_single\_backslash}}\label{extension-texux5fmathux5fsingleux5fbackslash}
...
\paragraph{\texorpdfstring{Extension:
\texttt{tex\_math\_double\_backslash}}{Extension: tex\_math\_double\_backslash}}\label{extension-texux5fmathux5fdoubleux5fbackslash}
...
\paragraph{\texorpdfstring{Extension:
\texttt{markdown\_attribute}}{Extension: markdown\_attribute}}\label{extension-markdownux5fattribute}
...
\paragraph{\texorpdfstring{Extension:
\texttt{mmd\_title\_block}}{Extension: mmd\_title\_block}}\label{extension-mmdux5ftitleux5fblock}
...
\paragraph{\texorpdfstring{Extension:
\texttt{autolink\_bare\_uris}}{Extension: autolink\_bare\_uris}}\label{extension-autolinkux5fbareux5furis}

Makes all absolute URIs into links, even when not surrounded by pointy
braces \texttt{\textless{}...\textgreater{}}.

\paragraph{\texorpdfstring{Extension:
\texttt{ascii\_identifiers}}{Extension: ascii\_identifiers}}\label{extension-asciiux5fidentifiers}
...
\paragraph{\texorpdfstring{Extension:
\texttt{mmd\_link\_attributes}}{Extension: mmd\_link\_attributes}}\label{extension-mmdux5flinkux5fattributes}

Parses multimarkdown style key-value attributes on link and image
references. This extension should not be confused with the
\protect\hyperlink{extension-linkux5fattributes}{\texttt{link\_attributes}}
extension.
...
\paragraph{\texorpdfstring{Extension:
\texttt{mmd\_header\_identifiers}}{Extension: mmd\_header\_identifiers}}\label{extension-mmdux5fheaderux5fidentifiers}
...
\paragraph{\texorpdfstring{Extension:
\texttt{compact\_definition\_lists}}{Extension: compact\_definition\_lists}}\label{extension-compactux5fdefinitionux5flists}
