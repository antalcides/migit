...
# -*- coding: utf-8 -*-
"""
Fecha de creación: Tue Oct 20 12:38:21 2015
...
"""
def Paso_RK2(funcion,x,y0,t,h):
    f1=funcion(x,y0,t)
    f2=funcion(x+h*f1,y0,t+h)
    r=x+0.5*h*(f1+f2)
    return r
     
def Paso_RK4(funcion,x,y0,t,h):
    f1=funcion(x,y0,t)
    f2=funcion(x+0.5*h*f1,y0,t+0.5*h)
    f3=funcion(x+0.5*h*f2,y0,t+0.5*h)
    f4=funcion(x+h*f3,y0,t+h)
